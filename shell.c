...
int make_cond_command(char* str)
{
    ...
    while (str[end] != '\0' && str[end] != '\n')
    {
        ...
        if(str[end] == ';') // реализация последовательного выполнения команд
        {
            str[end] = '\0';
            end++;
...
char** get_args(char* str)
{
    ...
    char **args = (char **)malloc(sons_counter*sizeof(char *));
    for(int i = 0; i < sons_counter; i++) 
    {
